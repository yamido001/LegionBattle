...
namespace LBCSCommon
{
    public class RqLogin : IRequest
    {
        ...
        public RqLogin(string accountName, string password)
        {
            AccountName = accountName;
            Password = password;
        }

        public static RqLogin Deserialization(Dictionary<byte, object> parameters)
        {
            object accountObj;
            object passwordObj;
            ...
            RqLogin rqLogin = new RqLogin(accountName, password);
            return rqLogin;
        }
