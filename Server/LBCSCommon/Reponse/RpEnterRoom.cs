...
{
    public class RpEnterRoom : ResponseBase
    {
        public bool Result
        {
            get;
        ...
        public RpEnterRoom(bool result, int roomId, string roomName)
        {
            Result = result;
            RoomId = roomId;
            RoomName = roomName;
        ...
        public static RpEnterRoom Deserialization(Dictionary<byte, object> parameters)
        {
            ...
            return new RpEnterRoom((bool)resultObj, (int)roomIdObj, roomNameObj as string);
        }
