...
namespace GameBattle
{
	public class FighterSkill{
		...
		public FighterSkill(Fighter fighter, int[] skillList)
		{
			mFighter = fighter;
		...
		public void UseSkill(int skillId, int targetFighterId)
		{
			...
			if (IsSkillIdCd (skillId))
				return;
			BattleServer.Instance.FighterTryUseSkill (mFighter.ID, skillId, targetFighterId);
		}
